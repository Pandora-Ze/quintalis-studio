...
:::grid {cols=2 gap=4}
[!button text="Télécharger le patch (local)" icon="custom-jeu" variant="info" color="#8b5cf6" size="l"](/static/patchs/Patch_VF_v1.0.zip) [!badge variant="question" text="v1.0"]
